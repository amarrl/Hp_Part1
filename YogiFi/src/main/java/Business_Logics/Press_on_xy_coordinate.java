...
public class Press_on_xy_coordinate implements Nlp {
...
//          int Y = (int) attributes.get("Enter wait time");
          ...
          touchAction.press( point.point(X, Y)).perform();
//          Thread.sleep(Duration.ofSeconds(Y));
          
          nlpResponseModel.setMessage("Pressed on "+X+" and "+Y+"-ordinates");
          nlpResponseModel.setStatus(CommonConstants.pass);
          }catch (Exception e) {
			// TODO: handle exception
        	  nlpResponseModel.setMessage("Failed pressed on "+X+" and "+Y+"-ordinates");
