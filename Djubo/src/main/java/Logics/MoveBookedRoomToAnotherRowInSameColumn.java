...
public class MoveBookedRoomToAnotherRowInSameColumn implements Nlp {
	@InputParams({ @InputParam(name = "Start Date", type = "java.lang.String"),
		@InputParam(name = "Start Room Name", type = "java.lang.String"),
		@InputParam(name = "Move Room Name", type = "java.lang.String"),
	...
	public NlpResponseModel execute(NlpRequestModel nlpRequestModel) throws NlpException {
		...
		String roomName2 = (String) attributes.get("Move Room Name");
		...
		try {
			...
			.moveToElement(driver.findElement(By.xpath(
					"//div[@class='booking-details active bars"+num+"']/table/tbody/tr[count(//a[.='"+category+"']/ancestor::div[@class='booking-data ng-scope closedSide']/descendant::table/tbody/tr/td[text()='"+roomName2+"']/parent::tr/preceding-sibling::tr)+"+noOfRooms+"]/td[count(//*[text()='"+date+"']/ancestor::td/preceding-sibling::td)+"+noOfNights+"]/span")))
			.release().perform();
			nlpResponseModel.setMessage("The selected reservation room is moved to "+roomName2);
